...
<html lang="zh-CN">
  ...
  <body>
    <!--导航栏部jsp:include page="include/header.jsp"-->
        ...
        <div class="col-sm-offset-2 col-md-offest-2">
            ...
            <div  class="form-horizontal">
                <div class="form-group">
                    <label for="inputName" class="col-sm-2 col-md-2 control-label">用户名</label>
    ...
    <script type="text/javascript">
        function startLogin() {
            ...
            var user = {};
            var loginResult = "";
            user.userName = document.getElementById("inputName").value;
            ...
            if(loginResult == 'success'){
                ...
                window.location.href = "${cp}userManager";
            }
